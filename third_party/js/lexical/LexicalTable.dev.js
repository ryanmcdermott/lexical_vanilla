...
/** @noInheritDoc */
export class TableCellNode extends lexical.DEPRECATED_GridCellNode {
    /** @internal */
...
/** @noInheritDoc */
export class TableRowNode extends lexical.DEPRECATED_GridRowNode {
    /** @internal */
    static getType() {
        return 'tablerow';
    }
...
export function $createTableRowNode(height) {
...
export function applyTableHandlers(tableNode, tableElement, editor, hasTabHandler) {
...
export function getTableSelectionFromTableElement(tableElement) {
    return tableElement[LEXICAL_ELEMENT_KEY];
}
export function getCellFromTarget(node) {
...
/** @noInheritDoc */
export class TableNode extends lexical.DEPRECATED_GridNode {
    /** @internal */
    static getType() {
        return 'table';
    }
...
export function $getElementGridForTableNode(editor, tableNode) {
 ...
 *
 */
export function $createTableNodeWithDimensions(rowCount, columnCount, includeHeaders = true) {
...
export function $getTableCellNodeFromLexicalNode(startingNode) {
...
export function $getTableRowNodeFromTableCellNodeOrThrow(startingNode) {
...
export function $getTableNodeFromLexicalNodeOrThrow(startingNode) {
...
export function $getTableRowIndexFromTableCellNode(tableCellNode) {
    const tableRowNode = $getTableRowNodeFromTableCellNodeOrThrow(tableCellNode);
    const tableNode = $getTableNodeFromLexicalNodeOrThrow(tableRowNode);
    return tableNode.getChildren().findIndex(n => n.is(tableRowNode));
}
export function $getTableColumnIndexFromTableCellNode(tableCellNode) {
    const tableRowNode = $getTableRowNodeFromTableCellNodeOrThrow(tableCellNode);
...
export function $removeTableRowAtIndex(tableNode, indexToDelete) {
...
export function $insertTableRow(tableNode, targetIndex, shouldInsertAfter = true, rowCount, grid) {
    const tableRows = tableNode.getChildren();
...
export function $insertTableColumn(tableNode, targetIndex, shouldInsertAfter = true, columnCount, grid) {
    const tableRows = tableNode.getChildren();
...
export function $deleteTableColumn(tableNode, targetIndex) {
    const tableRows = tableNode.getChildren();
...
export const INSERT_TABLE_COMMAND = lexical.createCommand('INSERT_TABLE_COMMAND');
