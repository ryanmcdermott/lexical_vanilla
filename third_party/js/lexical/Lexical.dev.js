...
export const SELECTION_CHANGE_COMMAND = createCommand('SELECTION_CHANGE_COMMAND');
export const CLICK_COMMAND = createCommand('CLICK_COMMAND');
export const DELETE_CHARACTER_COMMAND = createCommand('DELETE_CHARACTER_COMMAND');
export const INSERT_LINE_BREAK_COMMAND = createCommand('INSERT_LINE_BREAK_COMMAND');
export const INSERT_PARAGRAPH_COMMAND = createCommand('INSERT_PARAGRAPH_COMMAND');
export const CONTROLLED_TEXT_INSERTION_COMMAND = createCommand('CONTROLLED_TEXT_INSERTION_COMMAND');
export const PASTE_COMMAND = createCommand('PASTE_COMMAND');
export const REMOVE_TEXT_COMMAND = createCommand('REMOVE_TEXT_COMMAND');
export const DELETE_WORD_COMMAND = createCommand('DELETE_WORD_COMMAND');
export const DELETE_LINE_COMMAND = createCommand('DELETE_LINE_COMMAND');
export const FORMAT_TEXT_COMMAND = createCommand('FORMAT_TEXT_COMMAND');
export const UNDO_COMMAND = createCommand('UNDO_COMMAND');
export const REDO_COMMAND = createCommand('REDO_COMMAND');
export const KEY_DOWN_COMMAND = createCommand('KEYDOWN_COMMAND');
export const KEY_ARROW_RIGHT_COMMAND = createCommand('KEY_ARROW_RIGHT_COMMAND');
export const MOVE_TO_END = createCommand('MOVE_TO_END');
export const KEY_ARROW_LEFT_COMMAND = createCommand('KEY_ARROW_LEFT_COMMAND');
export const MOVE_TO_START = createCommand('MOVE_TO_START');
export const KEY_ARROW_UP_COMMAND = createCommand('KEY_ARROW_UP_COMMAND');
export const KEY_ARROW_DOWN_COMMAND = createCommand('KEY_ARROW_DOWN_COMMAND');
export const KEY_ENTER_COMMAND = createCommand('KEY_ENTER_COMMAND');
export const KEY_SPACE_COMMAND = createCommand('KEY_SPACE_COMMAND');
export const KEY_BACKSPACE_COMMAND = createCommand('KEY_BACKSPACE_COMMAND');
export const KEY_ESCAPE_COMMAND = createCommand('KEY_ESCAPE_COMMAND');
export const KEY_DELETE_COMMAND = createCommand('KEY_DELETE_COMMAND');
export const KEY_TAB_COMMAND = createCommand('KEY_TAB_COMMAND');
export const INSERT_TAB_COMMAND = createCommand('INSERT_TAB_COMMAND');
...
export const DROP_COMMAND = createCommand('DROP_COMMAND');
export const FORMAT_ELEMENT_COMMAND = createCommand('FORMAT_ELEMENT_COMMAND');
export const DRAGSTART_COMMAND = createCommand('DRAGSTART_COMMAND');
export const DRAGOVER_COMMAND = createCommand('DRAGOVER_COMMAND');
export const DRAGEND_COMMAND = createCommand('DRAGEND_COMMAND');
export const COPY_COMMAND = createCommand('COPY_COMMAND');
export const CUT_COMMAND = createCommand('CUT_COMMAND');
export const SELECT_ALL_COMMAND = createCommand('SELECT_ALL_COMMAND');
export const CLEAR_EDITOR_COMMAND = createCommand('CLEAR_EDITOR_COMMAND');
export const CLEAR_HISTORY_COMMAND = createCommand('CLEAR_HISTORY_COMMAND');
export const CAN_REDO_COMMAND = createCommand('CAN_REDO_COMMAND');
export const CAN_UNDO_COMMAND = createCommand('CAN_UNDO_COMMAND');
export const FOCUS_COMMAND = createCommand('FOCUS_COMMAND');
export const BLUR_COMMAND = createCommand('BLUR_COMMAND');
export const KEY_MODIFIER_COMMAND = createCommand('KEY_MODIFIER_COMMAND');
...
export function isSelectionCapturedInDecoratorInput(anchorDOM) {
...
export function isSelectionWithinEditor(editor, anchorDOM, focusDOM) {
...
export function getNearestEditorFromDOMNode(node) {
...
export function $setCompositionKey(compositionKey) {
  errorOnReadOnly();
  const editor = getActiveEditor();
...
export function $getNodeByKey(key, _editorState) {
...
export function $getNearestNodeFromDOMNode(startingDOM, editorState) {
  let dom = startingDOM;
...
export function $nodesOfType(klass) {
  const editorState = getActiveEditorState();
...
export function $hasUpdateTag(tag) {
  const editor = getActiveEditor();
  return editor._updateTags.has(tag);
}
export function $addUpdateTag(tag) {
  errorOnReadOnly();
  const editor = getActiveEditor();
...
export function $hasAncestor(child, targetNode) {
...
export function $isInlineElementOrDecoratorNode(node) {
  return $isElementNode(node) && node.isInline() || $isDecoratorNode(node) && node.isInline();
}
export function $getNearestRootOrShadowRoot(node) {
...
export function $isRootOrShadowRoot(node) {
...
export function $applyNodeReplacement(node) {
  const editor = getActiveEditor();
...
export function isHTMLAnchorElement(x) {
...
export function $isRangeSelection(x) {
...
export function DEPRECATED_$isGridSelection(x) {
...
export function $isNodeSelection(x) {
...
export function $isBlockElementNode(node) {
...
export function $insertNodes(nodes, selectStart) {
...
export function $parseSerializedNode(serializedNode) {
...
export function $isDecoratorNode(node) {
...
export const COMMAND_PRIORITY_CRITICAL = 4; // eslint-disable-next-line @typescript-eslint/no-unused-vars
...
export function DEPRECATED_$isGridCellNode(node) {
...
export function DEPRECATED_$isGridNode(node) {
...
export function DEPRECATED_$isGridRowNode(node) {
