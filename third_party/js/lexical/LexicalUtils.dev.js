...
export function removeClassNamesFromElement(element, ...classNames) {
    classNames.forEach(className => {
        if (typeof className === 'string') {
...
export function isMimeType(file, acceptableMimeTypes) {
...
export function mediaFileReader(files, acceptableMimeTypes) {
...
export function $dfs(startingNode, endingNode) {
    const nodes = [];
...
export function $getNearestNodeOfType(node, klass) {
    let parent = node;
...
export function $getNearestBlockElementAncestorOrThrow(startNode) {
 ...
 */
export function $findMatchingParent(startingNode, findFn) {
 ...
 */
export function mergeRegister(...func) {
    return () => {
        func.forEach(f => f());
    };
}
...
export function registerNestedElementResolver(editor, targetNode, cloneNode, handleOverlap) {
...
export function $restoreEditorState(editor, editorState) {
...
export function $insertNodeToNearestRoot(node) {
...
export function $wrapNodeInElement(node, createElementNode) {
 ...
 */
export function objectKlassEquals(object, objectClass) {
...
export function $filter(nodes, filterFn) {
    const result = [];
...
export function $insertFirst(parent, node) {
