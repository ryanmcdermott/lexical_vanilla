 ...
 */
export function $findTextIntersectionFromCharacters(root, targetCharacters) {
...
export function $isRootTextContentEmpty(isEditorComposing, trim = true) {
...
export function $isRootTextContentEmptyCurry(isEditorComposing, trim) {
