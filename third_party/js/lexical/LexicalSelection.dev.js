...
export function $cloneWithProperties(node) {
...
export function $sliceSelectedTextNodeContent(selection, textNode) {
...
export function $isAtNodeEnd(point) {
    if (point.type === 'text') {
...
export function trimTextContentFromAnchor(editor, anchor, delCount) {
...
export function $patchStyleText(selection, patch) {
...
export function $setBlocksType(selection, createElement) {
...
export function $wrapNodes(selection, createElement, wrappingElement = null) {
    const nodes = selection.getNodes();
...
export function $shouldOverrideDefaultCharacterSelection(selection, isBackward) {
...
export function $moveCaretSelection(selection, isHoldingShift, isBackward, granularity) {
...
export function $isParentElementRTL(selection) {
    const anchorNode = selection.anchor.getNode();
...
export function $moveCharacter(selection, isHoldingShift, isBackward) {
...
export function $getSelectionStyleValueForProperty(selection, styleProperty, defaultValue = '') {
    let styleValue = null;
    const nodes = selection.getNodes();
    const anchor = selection.anchor;
    const focus = selection.focus;
