...
export function $getLexicalContent(editor) {
    const selection = lexical.$getSelection();
...
export function $insertDataTransferForPlainText(dataTransfer, selection) {
...
export function $insertDataTransferForRichText(dataTransfer, selection, editor) {
...
export function $generateJSONFromSelectedNodes(editor, selection) {
    const nodes = [];
...
export async function copyToClipboard(editor, event) {
