...
export const DRAG_DROP_PASTE = lexical.createCommand('DRAG_DROP_PASTE_FILE');

/** @noInheritDoc */
export class QuoteNode extends lexical.ElementNode {
    static getType() {
        return 'quote';
    }
...
/** @noInheritDoc */
export class HeadingNode extends lexical.ElementNode {
    /** @internal */
    static getType() {
        return 'heading';
    }
...
export function $createHeadingNode(headingTag) {
...
export function registerRichText(editor) {
