...
/** @noInheritDoc */
export class ListItemNode extends lexical.ElementNode {
    /** @internal */
...
/** @noInheritDoc */
export class ListNode extends lexical.ElementNode {
    /** @internal */
...
/** @module @lexical/list */
export const INSERT_UNORDERED_LIST_COMMAND = lexical.createCommand('INSERT_UNORDERED_LIST_COMMAND');
export const INSERT_ORDERED_LIST_COMMAND = lexical.createCommand('INSERT_ORDERED_LIST_COMMAND');
export const INSERT_CHECK_LIST_COMMAND = lexical.createCommand('INSERT_CHECK_LIST_COMMAND');
export const REMOVE_LIST_COMMAND = lexical.createCommand('REMOVE_LIST_COMMAND');
